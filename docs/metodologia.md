...
*   **UI/UX:** Desarrollar las pantallas para web en Next.js  y componentes mobile en Expo/React Native.
*   **SEO & Semántica (Web):** Para pantallas públicas, definir metadatos en `<Head>` e implementar `accessibilityRole` en elementos clave.
