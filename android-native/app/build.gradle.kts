...
android {
    ...
    val mapsApiKey = localProperties.getProperty("MAPS_API_KEY") ?: System.getenv("MAPS_API_KEY") ?: "MOCK_API_KEY"
...
dependencies {
    ...
    // Compose Navigation & Lifecycle Viewmodel
    ...
    // WorkManager & Hilt Work Extension
    ...
    // Room Database for local cache & offline queue
    ...
    // Stripe SDK for PaymentSheet integration
